...
>
> 作成日: 2026-09-13 ／ 更新日: 2026-09-13 ／ ステータス: ドラフト（**8章の質問事項への回答待ち**。v0.1 の質問 Q1〜Q14 は 8.1 に、v0.2 で新たに生じた質問 Q15〜Q28 は 8.2 にまとめた）
...
DB マイグレーション `rehearsal_management` / `rehearsal_google_calendar`（v0.1）は適用済み。フェーズ A では `rh_members` からのデータ移行を伴うため、本番データが入る前に着手するのが望ましい。
